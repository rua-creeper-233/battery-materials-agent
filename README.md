...
- 证据库共 55 篇：16 篇核心论文完成 DOI 与 WOS Core Collection 核验，另有 39 篇完成 DOI 与出版社/权威索引记录核验；
- 53/55 篇已有用户合法取得或公开可访问的本地正文，共 3199 个带页码文本块；缺失项明确标记并回退到 DOI/出版社入口；
...
新增可审计标签与检索权重训练：当前 55 篇中，DFT 31 篇、MD 27 篇、VASP 12 篇、MS 7 篇、方法论文 27 篇、进展论文 28 篇。`MS` 专指论文方法明确使用 BIOVIA Materials Studio 的条目，不能根据背景提及误标。标签规则与命中依据在 `data/paper_tags.json`。
